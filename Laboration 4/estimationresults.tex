Below follows the results of the failure estimation as well as the estimation methods used. 
...
To use the Goel-Okumoto method, described in section~\ref{methods}, a program, \code{go.m}, was used to calculate the variables $a=547.5$ and $b=0.0242$.
